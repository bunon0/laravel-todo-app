  ...
  <div class="container h-100">
    ...
    <div class="row row-cols-1 row row-cols-md-2 row-cols-lg-3 g-4">
      @foreach ($goals as $goal)
        @include('modals.edit-goal')
        @include('modals.delete-goal')
        @include('modals.add-todo')
        ...
        <div class="col">
          <div class="card bg-light">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end text-center" aria-labelledby="dropdownGoalMenuLink">
                    <li>
                      <a href="#" class="dropdown-item" data-bs-toggle="modal"
                        data-bs-target="#editGoalModal{{ $goal->id }}">編集</a>
                    </li>
                    <div class="dropdown-divider"></div>
                    <li>
                      <a href="#" class="dropdown-item" data-bs-toggle="modal"
                        data-bs-target="#deleteGoalModal{{ $goal->id }}">削除</a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            @foreach ($goal->todos()->orderBy('done', 'asc')->get() as $todo)
              @include('modals.edit-todo')
              @include('modals.delete-todo')
